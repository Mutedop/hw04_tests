...
def post_edit(request, username, post_id):
    post = get_object_or_404(Post, author__username=username, id=post_id) # author__username=username
    ...
    form = PostForm(request.POST or None, instance=post) # or None for req.POST
